...
#define SW_EMER     PIND.4   //KHAC  B3
#define SW_ON       PINB.3   //KHAC  C3
#define SW_TANG     PINC.0   //KHAC  C4
#define SW_GIAM     PINC.1   //KHAC 
#define STR         PORTC.2
#define CLK         PORTC.3
#define SDI         PORTC.4
#define LED         PORTC.5
...
Timer_INIT();
INT0_INIT();
count_temp0=eepromRead(14);   //Load value from EEPROM
count_temp1=eepromRead(16);
