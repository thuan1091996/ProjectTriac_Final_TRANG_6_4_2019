...
void main(void)
{
count_temp0 = EEPROM_Read(200);   //Load value from EEPROM
count_temp1 = EEPROM_Read(210);
GPIO_INIT();
Timer_INIT();
INT0_INIT();
SIGNAL=0;
...
void Disable_INT(void)
{
    GICR|=(0<<INT1) | (0<<INT0);                                //Disable external interrupt 
    TIMSK&=~(0x05);                                             //Disable timer interrupts
}
///////////////////////////////////////////////////////////
void Enable_INT(void)
{
